...
public interface OpenGLES {
	...
	public void glBufferData(int target, int size, java.nio.Buffer data,
			int usage);
	...
	// bufsize, GLsizei *length, GLint *size, GLenum *type, char *name )
	public void glGetActiveAttrib(int program, int index, int bufsize,
			java.nio.IntBuffer length, java.nio.IntBuffer size,
			java.nio.IntBuffer type, byte name);
	...
	public void glGetActiveUniform(int 
			ogram, int index, int bufsize,
			int[] length, int lengthOffset, int[] size, int sizeOffset,
			int[] type, int typeOffset, byte[] name, int nameOffset);
	...
	// precisiontype, GLint *range, GLint *precision )
	public void glGetShaderPrecisionFormat(int shadertype, int precisiontype,
			java.nio.IntBuffer range, java.nio.IntBuffer precision);
	...
	public void glGetShaderSource(int shader, int bufsize,
			java.nio.IntBuffer length, byte source);
	...
	// C function void glShaderBinary ( GLsizei n, const GLuint *shaders, GLenum
	// binaryformat, const GLvoid *binary, GLsizei length )
	public void glShaderBinary(int n, java.nio.IntBuffer shaders,
			int binaryformat, java.nio.Buffer binary, int length);
	...
	// C function void glTexParameteriv ( GLenum target, GLenum pname, const
	// GLint *params )
	public void glTexParameteriv(int target, int pname,
			java.nio.IntBuffer params);
